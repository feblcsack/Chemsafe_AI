-- Hazmon Collection System Database Schema
-- Add these tables to your existing Supabase setup

-- Table: hazdex_entries (user's Hazmon collection)
...
-- Table: hazmon_scan_records (individual scan instances)
...
-- Table: hazmon_fusion_alerts (combination warnings shown to user)
