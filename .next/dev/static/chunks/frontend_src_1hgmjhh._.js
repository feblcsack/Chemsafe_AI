...
"[project]/frontend/src/components/LayoutWrapper.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Navigation({ currentPath }) {
    ...
    const adminLinks = [
        ...
        },
        {
            ...
            label: "New Zone",
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Shield$3e$__["Shield"]
        }
    ];
    const workerLinks = [
        {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "bg-ink/80 backdrop-blur-sm border-b border-white/10 sticky top-0 z-50",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: "/",
                                className: "font-display font-bold text-lg text-hazard",
                                children: "ChemSafe"
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: links.map((link)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: link.href,
                                        className: `flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-colors ${isActive ? "bg-hazard/20 text-hazard" : "text-steel hover:text-paper hover:bg-white/5"}`,
                                        children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-steel capitalize",
                                        children: userRole
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/src/components/Navigation.tsx",
                                        lineNumber: 85,
...
_s(Navigation, "oVWeu0QUxfDvptUHwZp6cpcRRrc=", false, function() {
    return [
...
"[project]/frontend/src/components/ServiceWorkerRegister.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const buttonVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-display font-semibold tracking-tight transition-all duration-200 disabled:pointer-events-none disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hazard focus-visible:ring-offset-2 focus-visible:ring-offset-ink", {
    variants: {
        variant: {
            default: "bg-hazard text-ink shadow-[0_0_0_1px_rgba(242,183,7,0.3),0_4px_20px_-4px_rgba(242,183,7,0.5)] hover:shadow-[0_0_0_1px_rgba(242,183,7,0.5),0_8px_28px_-4px_rgba(242,183,7,0.7)] hover:-translate-y-0.5",
            destructive: "bg-corrosive text-white hover:bg-corrosive/90",
            outline: "border border-white/15 bg-white/[0.02] text-paper hover:bg-white/[0.06] hover:border-white/25",
...
"[project]/frontend/src/lib/supabase/client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createClient() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserClient"])(("TURBOPACK compile-time value", "https://qfvxjasclrhcjhdpqoke.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFmdnhqYXNjbHJoY2poZHBxb2tlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODY1MzcxNzYsImV4cCI6MjEwMjExMzE3Nn0.L60DPxG2wrWgCQdYySZDWk2Kqlrh9gNJldP1jfMEiu0"));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/frontend/src/lib/supabase/userContext.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function resolveRoleFromProfile(user, profileRole) {
...
async function resolveCurrentUserContext() {
    ...
    const { data: profile } = await supabase.from("profiles").select("id, role, org_id, name, email").eq("id", user.id).maybeSingle();
    if (profile) {
        const role = resolveRoleFromProfile(user, profile.role);
        let orgId = profile.org_id ?? null;
        if (role === "admin" && !orgId) {
            const { data: org } = await supabase.from("organizations").select("id").eq("admin_id", user.id).maybeSingle();
            if (org?.id) {
                orgId = org.id;
            } else {
                const { data: createdOrg } = await supabase.from("organizations").insert({
                    name: `${profile.name || getPreferredName(user) || "Admin"}'s Organization`,
                    admin_id: user.id
    ...
    if (role === "admin") {
        ...
        if (org?.id) {
            ...
            const { data: createdOrg } = await supabase.from("organizations").insert({
                name: `${name || "Admin"}'s Organization`,
                admin_id: user.id
            }).select("id").maybeSingle();
            orgId = createdOrg?.id ?? null;
        }
    }
    const { data: recoveredProfile } = await supabase.from("profiles").upsert({
        id: user.id,
        role,
        org_id: orgId,
        name,
        ...
        onConflict: "id"
    }).select("id, role, org_id, name, email").maybeSingle();
    return {
        user,
...
//# sourceMappingURL=frontend_src_1hgmjhh._.js.map